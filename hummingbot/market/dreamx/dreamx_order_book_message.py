...
class DREAMXOrderBookMessage(OrderBookMessage):
    def __new__(
        cls,
    ...
    def asks(self) -> List[OrderBookRow]:
        raise NotImplementedError("DREAMX order book messages have different semantics.")
